...
- Extendable arm (probably scissor arm)
  ...
  - This one arm could do literally everything we need. Because of our X Drive and because it can go in and out, it might be able to literally pick up triballs in passing and swing around to put them into the goal without the robot stopping.
